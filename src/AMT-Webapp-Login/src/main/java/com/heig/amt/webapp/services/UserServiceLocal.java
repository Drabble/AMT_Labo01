 ...
 * core class of the business tier of our application.
 * The annotation @Local specifies that the interface will be implemented by an
 * EJB which will be instanciated by the application server
