...
/**
 * This class sets the root URL of our REST API (REpresentational State
 * Transfer) implemented using JAX-RS. It uses the annotation @ApplicationPath()
 * to set this base url to "/api"
 *
